...
select * from book
where bookid in (12,13,14);              -- 12, 13, 14번의 bookid들 출력. 
...
as select orderid, o.custid, username, o.bookid, saleprice, orderdate           -- 컬럼 지정.
...
as select c.custid, username, address                         -- 테이블에 공통되는 컬럼이 있으면 구분을 해주고(c.) 유일한 컬럼이면 냅둠.
