...
-- orderdate 컬럼을 특정 형식(포멧)의 문자열로 변환하여 반환하기.
...
select cast(orderdate as datetime) as 'orderdate 활용' from orders;     -- 시분초까지 필요하다면. 
...
select orderdate, date_add(orderdate, interval 1 month) from orders;         -- orderdate와 비교해보기
